...
*/
    ...
    static void addItemToDatabase(Context context, ItemInfo item, long container,
      ...
      //  Uri.parse(Users.User.CONTENT_URI+"/"+PersonalityProvider.TABLE_WIDGET), values
...
*/
    ...
    public void startLoader(Context context, boolean isLaunching, boolean isLocaleChanged) {
        mLocaleChanged = isLocaleChanged;
    ...
    private class LoaderTask implements Runnable {
        ...
        public void run() {
            ...
            final boolean loadWorkspaceFirst = cbk != null ? false : true;
...
//            	return;
//            }
            final ItemInfo occupied[][][] = new ItemInfo[EasyLauncher.SCREEN_COUNT][EasyLauncher.NUMBER_CELLS_X][EasyLauncher.NUMBER_CELLS_Y];
            ...
            try {
                ...
                final int ViewId = c.getColumnIndexOrThrow(
                        LauncherSettings.Favorites.VIEWID);
            ...
            if (DEBUG_LOADERS) {
                ...
                for (int y = 0; y < EasyLauncher.NUMBER_CELLS_Y; y++) {
                    String line = "";
                    for (int s = 0; s < EasyLauncher.SCREEN_COUNT; s++) {
                        if (s > 0) {
                            line += " | ";
                        }
                        for (int x = 0; x < EasyLauncher.NUMBER_CELLS_X; x++) {
        ...
        private void loadAndBindAllApps() {
            ...
            if (!mAllAppsLoaded || mLocaleChanged) {
                loadAllAppsByBatch();
                if (mStopped) {
                    return;
                }

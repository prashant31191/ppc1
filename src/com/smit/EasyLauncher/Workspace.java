...
public class Workspace extends ViewGroup implements DropTarget, DragSource, DragScroller {
    ...
    private static final String TAG = "EasyLauncher.Workspace";
    private static final int INVALID_SCREEN = -1;
    
	public final static int TYPE_WIDGET=0;
   ...
   // private final WallpaperManager mWallpaperManager;
    ...
    private void initWorkspace() {
        ...
        EasyLauncher.setScreen(mCurrentScreen);
...
//                }
    ...
    private void snapToScreen(int whichScreen, int velocity, boolean settle) {
        ...
        mLauncher.setPagebuttonFocus(mCurrentScreen+1, false);
        mLauncher.setPagebuttonFocus(whichScreen+1, true);
        clearVacantCache();
    ...
    void startDrag(CellLayout.CellInfo cellInfo) {
        ...
        if(child instanceof MyViewctrl){
...
//                if (mLauncher.IsOvewRecy((int)x, (int)y)&&mDragInfo.type== TYPE_WIDGET) {
//    				//É¾µôÍ¼±ê
//    				if(mDragInfo.type== TYPE_WIDGET){
//    					//mPeractivity.Icondlg(mLauncher.DIALOG_DELICON);
//    					mLauncher.delAWidget(mDragInfo.cell);
//    					//mLauncher.saveWidgetDatebase();
//    				}
//    				return;
//    			}
...
//            view = mLauncher.createShortcut(R.layout.application, cellLayout, (ShortcutInfo)info);
    ...
    void setLauncher(EasyLauncher easyLauncher) {
        mLauncher = easyLauncher;
    }
    ...
    public void onDropCompleted(View target, boolean success) {
        ...
        if (success){
            ...
            if (target != this && mDragInfo != null && info.itemType==LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET) {

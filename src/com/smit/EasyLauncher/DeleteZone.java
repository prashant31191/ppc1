...
public class DeleteZone extends ImageView implements DropTarget, DragController.DragListener {
    ...
    public void onDrop(DragSource source, int x, int y, int xOffset, int yOffset,
        ...
        if(LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET!=item.itemType) return;
...
//        } else 
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (item != null && item.itemType==LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET) {
            mTrashMode = true;
            createAnimations();
    ...
    void setLauncher(EasyLauncher launcher) {
        mLauncher = launcher;
    }

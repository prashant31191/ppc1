...
import com.smit.EasyLauncher.LauncherSettings.Favorites;

import com.smit.EasyLauncher.R;

public class LauncherProvider extends ContentProvider {
    private static final String TAG = "EsayLauncher.LauncherProvider";
    private static final boolean LOGD = false;

    private static final String DATABASE_NAME = "EsayLauncher.db";
    
    private static final int DATABASE_VERSION = 8;

    static final String AUTHORITY = "com.android.EsayLauncher.EsayLauncherProvider";
    ...
    static final Uri CONTENT_OWNWIDGET_RESET_URI =
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String TAG_OWNWIDGET="ownwidget";
        ...
        DatabaseHelper(Context context) {
            ...
            mContext = context;
            mAppWidgetHost = new AppWidgetHost(context, EasyLauncher.APPWIDGET_HOST_ID);
        }
        ...
        private void sendAppWidgetResetNotify() {
            ...
            resolver.notifyChange(CONTENT_OWNWIDGET_RESET_URI, null);
        }
        ...
        private boolean addOwnWidget(SQLiteDatabase db, ContentValues values, TypedArray a)
        {
        	
        	 boolean allocatedAppWidgets = false;
        	//String packageName = a.getString(R.styleable.Favorite_packageName);
            String viewid= a.getString(R.styleable.Favorite_viewid);
            if (viewid == null ) {
                return false;
            }
            else
            {
               ...
               //values.put(Favorites.INTENT, intent.toUri(0));
            	  try {
                      values.put(Favorites.VIEWID, viewid);
                      
                      values.put(Favorites.ITEM_TYPE, Favorites.ITEM_TYPE_OWNEIDGET);

...
public class TvLiveChannelProgramParse {
        ...
        + "/tflash/temp/";
  		...
  		//读取str
  		public  TvLiveChannelProgramParse(String str){
  			strSrc=str;
  		...
  		//读取xml
		public  TvLiveChannelProgramParse(InputStream InputStream){
		...
		//读取url
		public  TvLiveChannelProgramParse(URL url){
